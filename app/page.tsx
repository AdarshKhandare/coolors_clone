    ...
    <main className="flex  lg:flex-row flex-col-reverse  items-center justify-between  lg:py-14">
      ...
      <motion.div
        ...
        <motion.h1
          ...
          className="lg:text-6xl text-4xl max-w-[600px] tracking-tight mx-auto font-black text-center mb-[30px] ml-[-10px]">
          The super fast color palettes generator!
        </motion.h1>
        <motion.p
          variants={FADE_DOWN_ANIMATION_VARIANTS}
          className="text-md max-w-[450px] mb-[35px] mx-auto font-medium text-[#464853] text-center">
        ...
        <div className="w-[290px] mx-auto">
          <motion.button
            ...
            className="bg-[#0066ff] w-full text-white font-semibold h-[46px] px-[21px] my-3 rounded-lg">
            <Link href={"/generator"}>Start the generator!</Link>
          </motion.button>
      ...
      <motion.div
        ...
        whileHover={{ scale: 1.2 }}
        ref={scope}
        className="w-full xl:p-32 p-2 lg:mb-0 mb-10 xl:mt-0 lg:mt-28 mt-5  ">
        <svg
          version="1.1"
          ...
          <g id="homepage_hero-generator-laptop-mobile">
            <path
              className="first"
              d="M324.79,16.12h112c2.2,0,4,1.8,4,4v255h-116V16.12z"></path>
            <rect
              x="249.79"
              y="16.12"
              fill="yellow"
            ...
            <path
              fill="purple"
              className=" fifth"
              d="M59.79,16.12h74v259h-78v-255C55.79,17.92,57.59,16.12,59.79,16.12z"></path>
          </g>
          <path
            fill="#c9c8cc"
